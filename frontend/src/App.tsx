  ...
  return (
    <footer className="app-footer">
      ...
      <p className="app-footer_legal">
        ...
        <a href="https://github.com/PetarMc1">PetarMc1</a>. Licensed under
        Apache License 2.0. <br /> Not affiliated with{" "}
  ...
  return (
    <>
      ...
      <section className="card static-page" aria-labelledby="terms-title">
        ...
        <p>
          These Terms of Service govern access to and use of this GitRSS
          service.
        </p>
  ...
  return (
    <section className="api-docs-page" aria-labelledby="api-docs-title">
      <div className="api-docs-header">
        <h2 id="api-docs-title" className="static-page_title">
          API Docs
        </h2>
      </div>
  ...
  if (!adminPassword) {
    return (
      <>
        ...
        <section
          className="card static-page"
          aria-labelledby="admin-login-title"
        >
          <h2 id="admin-login-title" className="static-page_title">
            Admin
          </h2>
          <p className="static-page_updated">
            Sign in with the admin password configured on the backend.
          </p>
      ...
      <section className="admin-page" aria-labelledby="admin-title">
        <div className="card static-page">
          <div className="admin-header-row">
            <div>
              <h2 id="admin-title" className="static-page_title">
                Admin
              </h2>
              <p className="static-page_updated">
                Last snapshot:{" "}
          ...
          {loading && !overview && (
            <p className="static-page_empty">Loading admin data...</p>
          )}
            ...
            <>
              <div className="admin-summary-grid">
                <div className="admin-summary-card">
                  <span>Redis</span>
                  <strong>
                    {overview.redisAvailable ? "Available" : "Unavailable"}
                  </strong>
                </div>
                <div className="admin-summary-card">
                  <span>GitHub remaining</span>
                  <strong>
                    {overview.githubRateLimit.remaining !== null &&
                    overview.githubRateLimit.limit !== null
              ...
              <div className="admin-section">
                ...
                <p className="static-page_updated">
                  Deep and non-deep cache pages are separated below.
                </p>
                ...
                {overview.cache.repoBreakdown.filter(
                  (entry) => entry.deepCachedPages > 0,
                ).length === 0 ? (
                  <p className="static-page_empty">
                    No deep cached repos found.
                  </p>
                ) : (
                  <div className="admin-table-wrap">
                    <table className="admin-table">
                ...
                {overview.cache.repoBreakdown.filter(
                  (entry) => entry.nonDeepCachedPages > 0,
                ).length === 0 ? (
                  <p className="static-page_empty">
                    No non-deep cached repos found.
                  </p>
                ) : (
                  <div className="admin-table-wrap">
                    <table className="admin-table">
                        ...
                        {overview.cache.repoBreakdown
                          ...
                          .map((entry) => (
                            <tr key={`${entry.repoScope}-non-deep`}>
                              ...
                              <td>{entry.nonDeepCachedPages}</td>
                              <td>
                                {formatTtlSeconds(entry.nonDeepTtlSeconds)}
                              </td>
                            </tr>
                          ))}
                      </tbody>
...
function HomePage({
  ...
  const [commitFilters, setCommitFilters] = useState<CommitFiltersState>({
    branches: "",
  });
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="pagename"
          content="GitRSS - GitHub Repository RSS Feed Generator"
        />
        <meta
          property="og:title"
          content="GitRSS - GitHub Repository RSS Feed Generator"
        ...
        <meta
          name="description"
          content="Generate RSS feeds for GitHub repositories, commits, releases, tags, issues, and pull requests with GitRSS. Simple, fast, and free GitHub RSS feed generation for developers and automation workflows."
        />
        <meta
            ...
            title={
              backendStatus === "unreachable"
                ...
                : backendStatus === "degraded"
                  ? "Some backend services are degraded"
                  : undefined
            }
          >
            Generate RSS Feed
    ...
    <div className={`app ${route === "/api-docs" ? "app--wide" : ""}`}>
      <header className="app-header">
        ...
        <p className="app-subtitle">
          Generate RSS feeds for GitHub repositories
        </p>
